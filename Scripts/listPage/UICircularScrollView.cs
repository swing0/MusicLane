...
namespace CircularScrollView
{
    ...
    public class UICircularScrollView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        protected Action<GameObject, MapMessage> m_FuncCallBackFunc;
        protected Action<GameObject, MapMessage> m_FuncOnClickCallBack;
        ...
        private List<MapMessage> m_mapMessages = new List<MapMessage>();
        ...
        public virtual void Init(Action<GameObject, MapMessage> callBack)
        {


                Init(callBack, null);
        }
        public virtual void Init(Action<GameObject, MapMessage> callBack, Action<GameObject, MapMessage> onClickCallBack, Action<int, bool, GameObject> onButtonClickCallBack)
        {
        ...
        public virtual void Init(Action<GameObject, MapMessage> callBack, Action<GameObject, MapMessage> onClickCallBack)
        {
        ...
        public virtual void ShowList(int num, List<MapMessage> mapMessages)
        {
        ...
        //回调
        protected void Func(Action<GameObject, MapMessage> func, GameObject selectObject, bool isUpdate = false)
        {

            int num = int.Parse(selectObject.name) + 1;
            if (func != null)
            {
                func(selectObject, m_mapMessages[num - 1]);
            }
